    ...
    <section class="section dashboard">
        ...
        <div class="row">
            <div class="col-md-12 question_list"  id="question_list">
                ...
                <h2><?php echo e(strip_tags($question->question_title)); ?></h2>
                <ul>
...
<?php $__env->startSection('script'); ?>
    ...
    $.ajax({
    url: "<?php echo e(route('add.question')); ?>",
    method:'POST',
...
<?php echo $__env->make('../layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\online_module\resources\views/admin/questionBank.blade.php ENDPATH**/ ?>
                ...
                <div class="row">
                    <div class="col-lg-12 d-flex">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="container" id="rightContent" style="background-color: #f0f8ffbd;height:80vh;">
                                <div class="moduleWrap" style="">
                                    <div class="d-flex justify-content-between ">
                                        <a href="#" style=""> <input
                                            type="button" class="btn module_btn mt-3"
                                            value=" Search Course offered"></a>
                                    <a href="<?php echo e(route('login')); ?>" style=""> <input
...
<br>
    ...
    <script>
        ...
        $('#searchCourseBtn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('searchSubject')); ?>", // Your route to fetch courses
                type: 'POST',
                data: {
                    courseTxt: courseTxt
                },
        ...
        $('.course').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(url('/course')); ?>/" + courseId + "/programs",
                type: "GET",
                success: function(response) {
                    ...
                    <div class="accordion-body">
                        <div class="program-details">
                            ...
                            <ul>`;
                                program.program_vc_dates?.forEach(function(vc_date) {
                                    html +=
                                        `<li class="list-unstyled" ><strong>${vc_date.description}:</strong> ${formatDate(program.end_date)} ${formatDatesToAMPM(vc_date.vc_date)}</li>`;
                                });
                                html += `

                            </ul>
                             <p><strong>Panel Discussion Date:</strong> ${formatDate(program.exam_date)} ${formatDatesToAMPM(program.exam_date)}</p>
                             <p><strong>Exam Date:</strong> ${formatDate(program.exam_date)} ${formatDatesToAMPM(program.exam_date)}</p>
                        ...
                        $('.cltSubject').click(function() {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('getSubject')); ?>", // Your route to fetch courses
                                type: 'POST',
                                data: {
                                    course_id: courseId
                                },
                                success: function(response) {
                                    ...
                                    $(document).on('click', '.subject', function() {
                                        ...
                                        $.ajax({
                                            url: "<?php echo e(route('allTopics')); ?>", // Your route to fetch courses
                                            type: 'POST',
                                            data: {
      ...
      function loginToEnroll(program_id){
        $.ajax({
            url: "<?php echo e(route('loginToenroll')); ?>", // Your route to fetch courses
            type: 'POST',
            data: {
...
<?php /**PATH /var/www/html/mdrafm/online_module/resources/views/welcome.blade.php ENDPATH**/ ?>
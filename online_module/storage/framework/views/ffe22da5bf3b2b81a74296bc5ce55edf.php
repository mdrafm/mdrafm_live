                ...
                <div class="accordion" id="subjectAccordion">
                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading<?php echo e($subject->id); ?>">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapse<?php echo e($subject->id); ?>" aria-expanded="false"
                                        aria-controls="collapse<?php echo e($subject->id); ?>">
                                    <?php echo e($subject->subject_name); ?>

                                </button>
                            </h2>
                            <div id="collapse<?php echo e($subject->id); ?>" class="accordion-collapse collapse"
                                 aria-labelledby="heading<?php echo e($subject->id); ?>" data-bs-parent="#subjectAccordion">
                                <div class="accordion-body">
                                    <ul class="list-group subject-list">
                                        <?php $__empty_1 = true; $__currentLoopData = $subject->topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center"
                                                ...
                                                <div class="actionBtns d-flex justify-content-between align-items-center">
                                                    <button class="btn btn-sm btn-primary play-btn mx-1"
                                                            data-ppt="<?php echo e($topic->ppt_file); ?>"
                                                            data-topicId="<?php echo e($topic->id); ?>"
                                                            data-topicName="<?php echo e($topic->topic_name); ?>">
                                                        Play
                                                    </button>
                                                    <div class="form-check position-relative">
                                                        <input class="form-check-input ml-1 chkComplete"
                                                               data-topicId="<?php echo e($topic->id); ?>"
                                                               data-subjectId="<?php echo e($subject->id); ?>" type="checkbox"
                                                               <?php echo e($isCompleted ? 'checked' : ''); ?>>
                                ...
                                <form action="<?php echo e(route('practice-test')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <form id="queryFormContent">
                                            ...
                                            <div class="mb-3 techType" style="display:none" >
                                                ...
                                                <select class="form-select techQueryType" aria-label="Default select example">
                                                    ...
                                                    <option value="4">Unable to access the course material</option>
                                                    <option value="6">Unable to appear the test</option>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    submitQueryBtn.addEventListener('click', () => {
        ...
        $.ajax({
            url: '<?php echo e(route('query.store')); ?>',
            type: 'POST',
            dataType: 'json',
            data: {
    ...
    checkboxes.forEach(checkbox => {
        ...
        checkbox.addEventListener('click', function () {
            ...
            const program_id = <?php echo json_encode($program_id, 15, 512) ?>;

            // Send the completion status to the server
            $.ajax({
                url: '<?php echo e(route('save.progress')); ?>', // Laravel route to handle the save request
                type: 'POST',
                data: {
...
function loadRiseQuery(topicId) {
    const program_id = <?php echo json_encode($program_id, 15, 512) ?>;
    $.ajax({
        url: '<?php echo e(route('query.load')); ?>',
        type: 'POST',
        data: {
            _token: '<?php echo e(csrf_token()); ?>',
            topicId: topicId,
...
<?php echo $__env->make('../layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\online_module\resources\views/trainee/classRoom.blade.php ENDPATH**/ ?>
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" data-programId = <?php echo e($program->id); ?> class="btn btn-sm btn-primary approvebtn">Approve</a>
                            <a href="#" data-programId = <?php echo e($program->id); ?> class="btn btn-sm btn-danger">Reject</a>
...
$('.approvebtn').click('approvebtn',function(){
   ...
   $.ajax({
        url: "<?php echo e(route('cd.getPrograms')); ?>", // Your route to fetch courses
        type: 'POST',
        dataType: 'json',
        data: {
            programId: programId,
...
$('#approveBtn').click(function(){
   ...
   console.log(start_date,end_date);
    ...
    $.ajax({
         url: "<?php echo e(route('cd.approveProgram')); ?>", // Your route to fetch courses
         type: 'POST',
         dataType: 'json',
         data: {
             programId: programId,
...
<?php echo $__env->make('../layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\online_module\resources\views/courseDirector/approveProgram.blade.php ENDPATH**/ ?>
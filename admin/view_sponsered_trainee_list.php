                                ...
                                <div id="term2" class=" table table-responsive table-striped table-hover"
                                    ...
                                    <table class=" term table" id="traineeList">
                                        <thead class="" style="background: #315682;color:#fff;font-size: 11px;">
                                            ...
                                            <th style="text-align:center;width: 8rem;">Exam Status</th>
                                            <th style="text-align:center;width: 8rem;">Secured Mark</th>
        ...
        ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center;"><?php echo $row['phone']; ?> </td>
                                                 <td style="text-align:center;"><?php echo ($row['exam_result_status'] == 1)?'Appeared':'Not Appeared' ?></td>
                                                 <td style="text-align:center;"><?php echo $row['mark']; ?> </td>
                                                <td>
                                                    <?php
                                                        if($row['exam_result_status'] == 1){
                                                            echo 'Pass';
                                                        }else{
                                                             echo 'Fail';
                                                        }

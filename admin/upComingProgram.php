                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="card-title">Upcoming Programmes </h4>
                                    </div>
                                ...
                                <div class="row" style="margin-top:20px;">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div class="col-md-2" style="float:right">
                                        ...
                                        onclick="add('Upcoming Program','program','tbl_upcoming_program')"
                        ...
                        <div class="card">
                            ...
                            <div id="term2" class=" table table-responsive table-striped table-hover" style="width:85%;margin:0px auto" >
                              ...
                              //$db->select('tbl_news',"*",null,null,null,null);
                               $db->select_sql(' SELECT * FROM `tbl_upcoming_program` ORDER BY `tbl_upcoming_program`.`id`  DESC');
...
function add(str, frm, tbl) {
   ...
   // var form_data = new FormData();                  
    ...
    fd.append('tbl','tbl_upcoming_program');

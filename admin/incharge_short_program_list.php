                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    ...
                                                    <input type="button" class="m-2" style="background:#3292a2;border: 0;
                                                                                    ...
                                                                                    border-radius: 3px;
                                                                                    color: #fff;" name="send"
                                                        onclick="datapost('view_sponsered_time_table.php',{id: <?php echo $row['id'] ?> ,prog_name:<?php echo $prg_name;  ?>,from_dt:<?php echo $from_dt;  ?>,to_dt:<?php echo $to_dt; ?> })"
                                                        value="Time Table" /><br>
                                                    <input type="button" style="background: rgb(83 52 170);border: 0;
                                                                                        padding: 5px;
                                                                                        border-radius: 3px;
                                                                                        color: #fff;" name="send"
                                                        onclick="datapost('view_sponsered_trainee_list.php',{id: <?php echo $row['id'] ?> ,trng_type:<?php echo $row['trng_type']  ?> })"
                                                        value="Trainee List" />
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-8 text-left">
                                                                                            <select
                                                                                                ...
                                                                                                onchange="add_course_co(<?php echo $row['id'] ?>,<?php echo $row['course_director_id'] ?>,<?php echo $co_role ?>,<?php echo $row['trng_type']; ?>,'tbl_short_program_master')">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-8 ">
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    id="inh_asst_course_director_<?php echo $row['id'] ?>"
                                                                                                    style="height: calc(1em + 0.75rem + 2px);padding:0px"
                                                                                                    onchange="add_inh_asst_course_dir(<?php echo $row['id'] ?>,<?php echo $row['course_director_id'] ?>,<?php echo $asst_co_role ?>,<?php echo $row['trng_type']; ?>,'tbl_short_program_master')">
                                                    ...
                                                    <div class="modal fade"
                                                        id="shortTermModalSponsored_<?php echo $row['id'] ?>"
                                                        tabindex="-1" aria-labelledby="termModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-4 text-left">
                                                                                            <select
                                                                                                class="custom-select mr-sm-2"
                                                                                                name="course_director"
                                                                                                id="course_director_<?php echo $row['id'] ?>"  class="course_director_<?php echo $row['id'] ?>"
                                                                                                style="height: calc(1em + 0.75rem + 2px);padding:5px"
                                                                                                onchange="add_course_dir(<?php echo $row['id'] ?>,<?php echo $row['course_director_id'] ?>,<?php echo $co_role ?>,<?php echo $row['trng_type']; ?>,'tbl_short_program_master')">
                                                                                                <option>
                                                                                                    Select Course
                                                                                                    Director
                                                                                                </option>
                                                                                        ...
                                                                                        <div class="col-md-2 text-left">
                                                                                            <label for="">Assistant
                                                                                                course director</label>
                                                                                        </div>
                                                                                        <div class="col-md-4 text-left">
                                                                                            <select
                                                                                                class="custom-select mr-sm-2"
                                                                                                name="ass_course_director"
                                                                                                id="ass_course_director_<?php echo $row['id'] ?>"
                                                                                                style="height: calc(1em + 0.75rem + 2px);padding:5px"
                                                                                                onchange="add_asst_course_dir(<?php echo $row['id'] ?>,<?php echo $row['course_director_id'] ?>,<?php echo $asst_co_role ?>,<?php echo $row['trng_type']; ?>,'tbl_short_program_master')">
                                                                                                <option selected>
                                                                                                    Select assistant
                                                                                                    course director
                                                                                                </option>
                                                                                                ...
                                                                                                <option
                                                                                                    value="<?php echo $row4['id'] ?>"
                                                                                                    <?php echo ($row4['id'] == $asst_faculty_id )?'selected':'' ?>>
                                                                                                    <?php echo $row4['name'] ?>
                                                                                                </option>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <label class="ml-2" style="background-color: #82b08d;
                                                                                            border-radius: 5px;
                                                                                            color: #320d0d;
                                                                                            padding: 5px;">
                                                                                            <strong>Email
                                                                                                Draft</strong></label><br>

                                                                                        <input type="button"
                                                                                            class="btn btn-primary mr-2"
                                                                                            style="display: <?php echo ($row['mail_status']==1)?'none':''; ?>"
                                                                                            id="email_edit_<?php echo $row['id']?>"
                                                                                            onclick="edit_emai(<?php echo $row['id']?>)"
                                                                                            value="Edit" />
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    name="email_sub"
                                                                                                    class="email_sub"
                                                                                                    id="email_sub_<?php echo $row['id']?>"
                                                                                                    value="<?php echo $row['email_sub'] ?>"
                                                                                    ...
                                                                                    <input type="button"
                                                                                        ...
                                                                                        id="updt_btn_<?php echo $row['id']?>"
                                                                                        onclick="update_email(<?php echo $row['id']?>)"
                                                                                        value="Update"
                                                                                        style="display:none" />
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="modal-footer justify-content-between">
                                                                   ...
                                                                   // echo $row['status'];
                                                                    ...
                                                                    <button type="button" class="btn btn-info mail_btn"
                                                                        onclick="send_mail(<?php echo $row['id'] ?>,'<?php echo $row['dept_email'] ?>','<?php echo $row['dept_name'] ?>')">Send
                                                                        Email</button>
                                                                        <p class="text-success mailMsg"  ></p>
                                                                    <div class="loader">
...
<script type="text/javascript">
    //Inhouse program
function add_course_co(id,course_dir,roll,trng_type,tbl) {
...
let faculty_id = $(`#inh_asst_course_director_${id}`).val();
$.ajax({
    type: "POST",
    url: "ajax_master.php",
    data: {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (elm[0] == "success") {
                ...
                sessionStorage.type = "success";
                $('.mailMsg').text("Email send successfully");
                 $('.loader').hide();

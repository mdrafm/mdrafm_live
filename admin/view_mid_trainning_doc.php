...
echo "SELECT m.cousrse_material_id,c.subject,c.faculty_name,c.file_name,c.status  FROM `tbl_mid_course_material` m 
                                                                JOIN `tbl_mid_course_material_master` c ON m.cousrse_material_id = c.id
                                                                WHERE m.program_id = '$prog_id' ";
                                               ...
                                               foreach($db->getResult() as $row ){
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                            <a href="<?php echo '/admin/course_material/misc/'. $row['file_name'] ?> " download > 
                                                                     download
                                                                    </a> </br>

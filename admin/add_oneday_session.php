    ...
    <div class="wrapper ">
        ...
        <div class="main-panel" id="main-panel">
            ...
            <div class="content" style="margin-top: 50px;">
                <?php
                //print_r($_POST);
               if(!empty($_POST['t_date']) && !empty($_POST['program_id'])  && !empty($_POST['time_table']) && !empty($_POST['program_table']))
               {
                $session_date = $_POST['t_date'];
                $prog_id = $_POST['program_id'];
                $time_table = $_POST['time_table'];
                $program_table = $_POST['program_table'];
                $tt_range_id = $_POST['tt_range_id'];
                
                $_SESSION["session_date"]=$session_date;
                $_SESSION["prog_id"]=$prog_id;
                $_SESSION["time_table"]=$time_table;
                $_SESSION["program_table"]= $program_table;
                $_SESSION["tt_range_id"]= $tt_range_id;
               }
               if(empty($_POST['t_date']) && empty($_POST['program_id'])  && empty($_POST['time_table']) && empty($_POST['program_table']))
               {
                $session_date=$_SESSION["session_date"];
                $prog_id =$_SESSION["prog_id"];
                $time_table = $_SESSION["time_table"];
                $program_table= $_SESSION["program_table"];
                $tt_range_id= $_SESSION["tt_range_id"];
               }
            ...
            ?>
                ...
                <div class="row">
                <a href="add_time_table.php" style="margin-left:1%;padding:3px;font-size:15px" class="btn btn-primary"><< Back</a>
                   <!-- <div class="col-md-4">
                                    ...
                                    <div class="row">
                                       <div class="col-md-3">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="hidden" name="tt_range_id" value="<?php echo $tt_range_id?>">
...
<script type="text/javascript">
    ...
    //     e.preventDefault();
     function addOneDaySession(trng_type){
        ...
        else if(trng_type == 5 || trng_type ==7){
...
let table;
    ...
    if(trng_type == 3 || trng_type == 7 || trng_type == 4){
       table = "tbl_inhouse_time_table";
    }

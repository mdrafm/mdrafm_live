                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 class_room">
                            <div class="form-group">
                               ...
                               <input type="text" class="form-control " name="faculty_name" id="faculty_name" value="<?php echo $row['faculty_name']; ?>" placeholder="Faculty Name" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="otherSubject_<?php echo $i ?>">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control input-control" name="paper_covered" id="paperCovered_<?php echo $i ?>" placeholder="Enter Subject" rows="3" style="border: 1px solid #e3e3e3;border-radius:5px;"><?php echo $row['paper_covered']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>

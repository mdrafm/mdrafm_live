    ...
    <div class="wrapper ">
        ...
        <div class="main-panel" id="main-panel">
            ...
            <div class="content">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div id="room_details">
                                            <?php
                                            $db->select('tbl_class_room_master', "*", null, "status = 1 AND id= " . $_POST['id'], null, null);
                                            foreach ($db->getResult() as $row) {
                                                ?>
                                                <p>Class Room : <span class="class-name">
                                                        <?php echo $row['name'] ?>
                                                    </span></p>
                                                <p>Seating Capacity : <span class="seat">
                                                        <?php echo $row['capacity'] . ' participants' ?>
                                                    </span></p>
                                                ...
                                                foreach ($rents as $rent) {
                                                    ...
                                                    foreach ($db->getResult() as $row2) {
                                                        ...
                                                        <div class="rent d-flex justify-content-between ">
                                                            <p> Rent : <span class="price">₹
                                                                    <?php echo $row2['price'] ?>
                                                                </span> </p>
                                                            <button class="btn btn-info btn-sm">Book</button>
                                                        </div>
                                        ...
                                        <div class="booking_div">
                                            ...
                                            <div class="tab-content mt-3">
                                                <div class="tab-pane fade show active" id="inhouse">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select mr-sm-2"
                                                                    name="traning_type" id="traning_type">
                                                    ...
                                                    <div class="row d-flex justify-content-center">
                                                        <input type="button" class="btn  " style="background:#3292a2"
                                                            name="send" onclick="saveBookingInhouse()" value="Save" />
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="others">
                                                    ...
                                                    <div class="row d-flex justify-content-center">
                                                        <input type="button" class="btn  " style="background:#3292a2"
                                                            name="send" onclick="save_event()" value="Save" />
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="lists">
                                                   <!--  <div class="search">
                                                        <select class="custom-select mr-sm-2" name="month_id"
                                                            id="month">
                                                            ...
                                                            <table class="table  ">
                                                                ...
                                                                <tbody>
                                                                   <?php
                                                                    $room_id = $_POST['id'];
                                                                   // print_r($_POST);
                                                                //echo  $sql = "SELECT * FROM `tbl_class_room_booking_details` WHERE class_room_id = $room_id AND MONTH(from_dt) = $month_id ";
                                                                 $sql = "SELECT * FROM `tbl_class_room_booking_details` WHERE class_room_id = $room_id";
                                                                     ...
                                                                     foreach ($res as $row) {
                                                                         $cnt++;
                                                                          $curr = date("Y-m-d");
                                                                                        ...
                                                                                        $active = date('Y-m-d', strtotime($row['from_dt']));
                                                                                        $inActive = date('Y-m-d', strtotime($row['to_dt']));
                ...
                <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="event_start_date" id="start_date_edit"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="event_end_date" id="end_date_edit"
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="edit_booking_btn"
                                    onclick="update_booking()">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="edit_other_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="img-container">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="event_name"
                                                    id="event_name_edit" placeholder="Enter Booking Title">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="event_start_date">Start From </label>
                                                <input type="date" name="event_start_date" id="start_date_edit_other"
                                                    class="form-control onlydatepicker" placeholder="start date">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="event_end_date">End To</label>
                                                <input type="date" name="event_end_date" id="end_date_edit_other"
                                                    class="form-control" placeholder="Event end date">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="edit_other_booking_btn"
                                    onclick="update_other_booking()">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function display_events() {
        ...
        $.ajax({
            url: 'ajax_class_room_booking_details.php',
            data: { 'action': 'show_booking', 'room_id': room_id },
            method: 'POST',
            dataType: 'json',
            success: function (response) {
                // console.log(response);  

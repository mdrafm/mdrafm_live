...
<head>
    ...
    $db = new Database();
    if(!empty($_POST["from_dt"]) || !empty($_POST["to_dt"]) || !empty($_POST["trng_type"]))
    {
        $from_dt = $_POST["from_dt"];
        $to_dt = $_POST["to_dt"];
        $trng_type = $_POST['trng_type'];
        $prog_id=$_POST['prog_id'];
        $trn_range_id=$_POST['id'];
        $_SESSION["from_dt"]=$from_dt;
        $_SESSION["to_dt"]=$to_dt;
        $_SESSION["trng_type"]=$trng_type;
        $_SESSION["prog_id"]= $prog_id;
        $_SESSION["id"]= $trn_range_id;
    }
  
    if(empty($from_dt) || empty($to_dt))
    {
        $from_dt=$_SESSION["from_dt"];
        $to_dt=$_SESSION["to_dt"];
        $trng_type = $_SESSION["trng_type"];
        $prog_id = $_SESSION["prog_id"];
        $trn_range_id=$_SESSION["id"];
    }
    ...
    $subject_tbl='';
     ...
     if($trng_type == 3 || $trng_type ==4 || $trng_type ==7){
        ...
        $time_table = "tbl_sponsored_time_table";
    }
   //echo $time_table;
    // switch ($trng_type) {
    //     case ('1' || '2'):
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h5 class="card-title"> Time Table 1</h5>

                                <div class="row">
                                    <div class="col-md-7">
                                        Duration
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        : From <strong> <?=isset($from_dt)?$from_dt:''?> </strong> To
                                        <strong><?=isset($to_dt)?$to_dt:''?></strong>
                                    </div>
                                </div>
                                <form action="add_oneday_session.php" method="post">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select mr-sm-2" name="program_id" id="program">
                                                    ...
                                                    <?php 
                                                        ...
                                                        <?php echo ($row['id'] == $prog_id)?'selected': '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="hidden" name="tt_range_id" value="<?php echo $trn_range_id ?>" >
                                ...
                                <div id="term2" class=" table table-responsive table-striped table-hover">
                                    <table class=" term table">
                                        <thead class="" style="background: #315682;color:#fff;font-size: 11px;">
                                            ...
                                            //echo $time_table;
                                              $session_count = 0;
                                                 $db->select($time_table,"MAX(session_no) as session",null,"table_range_id = '".$trn_range_id."' AND trng_type =".$trng_type,null,null);
                                                   //print_r( $db->getResult());
                                        ...
                                        <tbody>
                                            ...
                                            $count = 0;
                                            $db->select($time_table,"DISTINCT training_dt",null,"table_range_id = '".$trn_range_id."' AND trng_type =".$trng_type,null,null);
                                            // print_r( $db->getResult());
                                            foreach($db->getResult() as $row){
                                                //print_r($row);
                                                $count++;
                                                ...
                                                <td class="session">
                                                    ...
                                                    <?php
                                                            switch ($res['break_time']) {
                                                               ...
                                                               if($res['other_class'] != 0){
                                                                    echo '<p>'. $res['class_remark']. '</p>' ;
                                                               }

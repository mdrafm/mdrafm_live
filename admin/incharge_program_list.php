                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    onchange="add_course_dir(<?php echo $row1['id'] ?>,<?php echo $row1['course_director_id'] ?>,8,<?php echo $row1['trng_type'] ?>,'tbl_program_master')">
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-md-8 ">
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        style="height: calc(1em + 0.75rem + 2px);padding:0px"
                                                                                                        onchange="add_asst_course_dir(<?php echo $row1['id'] ?>,<?php echo $row1['course_director_id'] ?>,13,<?php echo $row1['trng_type'] ?>,'tbl_program_master')">
...
// function add_course_dir(program_id, old_course_dir,roll,trng_type) {
...
//             action: action,
//             id: program_id,
//             course_dir : old_course_dir,
//             faculty_id: course_dir,
//             trng_type:trng_type,
//             roll_id: roll,
//             table: "tbl_program_master"
//         },
...
// function add_asst_course_dir(id,course_dir_id,roll,trng_type) {

...
$.ajax({
    url: "ajax_upload_mid_trainee.php",
    ...
    $('#import_excel_data tr').each(function(row, tr) {
        TableData[row] = {
            ...
            "name": $(tr).find('td:eq(1)').text(),
             "roll_no": $(tr).find('td:eq(2)').text(),
            "hrms_id": $(tr).find('td:eq(3)').text(),
            "desig": $(tr).find('td:eq(4)').text(),
            "office": $(tr).find('td:eq(5)').text(),
            "age": $(tr).find('td:eq(6)').text(),
            "sex": $(tr).find('td:eq(7)').text(),
            "category": $(tr).find('td:eq(8)').text(),
            "edu_qualification": $(tr).find('td:eq(9)').text(),
            "joining_date": $(tr).find('td:eq(10)').text(),
            "email": $(tr).find('td:eq(12)').text(),
            "phone": $(tr).find('td:eq(11)').text(),
            "previous_industry": $(tr).find('td:eq(13)').text()
        }
    });

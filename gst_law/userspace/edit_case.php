                                ...
                                <form id="frm_add" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                           ...
                                           <input type="text" class="form-control case_year" id="case_year" name="case_year[]" placeholder="Enter Case Year"
                autocomplete="off">
                <small class="text-danger" id="caseYear_err"></small>
                                        </div>
                                        <input type="hidden" name="ref_id[]" value="<?php echo $ref['id'] ?>">
                                        <div class="form-group col-md-2">
                                        <input type="button" class="btn btn-primary" value="Add" id="add_more_case" style="padding: 5px;margin-top: 2.5rem;width:50px">
    ...
    $('#add_more_case').click(function(){
       ...
       cnt++;
        ...
        $('#case_ref').append( `<div class="row" id="ref_case_div_${cnt}">
            ...
            <div class="form-group col-md-3">
                <label>Case Year :</label>
                <input type="text" class="form-control case_year2" name="case_year[]" placeholder="Enter Case Year"
                autocomplete="off">
                <small class="text-danger" id="caseYear_err"></small>
            </div>
            <div class="form-group col-md-2">

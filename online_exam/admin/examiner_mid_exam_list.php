...
var dataTable = $('#exam_table').DataTable({
            ...
            "order" : [],
            "ajax" : {
                url:"examiner_mid_exam_list_action.php",
                type:"POST",
                data:{action:'fetch'}
            },
            "column":[
...
function view_result(exam_id,exam_category,program_id)
{
    if(exam_category ==3){
        datapost('get_mid_traniee_result_list.php', {
                exam_id: exam_id,program_id:program_id
            });
    }else{
        datapost('get_traniee_result_list.php', {
                exam_id: exam_id,program_id:program_id

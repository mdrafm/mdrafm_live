...
<div>
    <button type="button" class="btn btn-primary" style="float: right;"
        onclick="datapost('<?php echo $result_url; ?>',{exam_id: <?php echo $post_exam_id ?>})">Print</button>
</div>
            ...
            <table class="table table-bordered" id="exam_result" width="100%" cellspacing="0">
                ...
                <tbody style="background-color:#eaf3f3">
                  ...
                  if($exam_category == 1){
                    ...
                    $object->query = "
                    SELECT tbl_trainee_info.user_id,tbl_exm_inf.id as info_id,tbl_trainee_info.name,tbl_trainee_info.phone,sum(tbl_qs_ans.marks) as tot_mark 
                    ...
                    group by tbl_qs_ans.trainee_exam_info_id";
                     ...
                     $object->query = "
                           ...
                           $object->query = "
                            SELECT tbl_exm_inf.id,tbl_trainee_info.user_id,tbl_exm_inf.id as info_id,tbl_trainee_info.name,tbl_trainee_info.phone,sum(tbl_qs_ans.marks) as tot_mark 
                            FROM `tbl_dept_trainee_registration` tbl_trainee_info
                            join tbl_trainee_exam_info tbl_exm_inf on tbl_exm_inf.trainee_id = tbl_trainee_info.user_id 
                            join tbl_exam_question_answer as tbl_qs_ans on  tbl_qs_ans.trainee_exam_info_id=tbl_exm_inf.id

          ...
          // print_r($_SESSION); 
           ...
           ?>
            ...
            <?php
                 ...
                 <li class="nav-item">
                    ...
                    <div id="exam_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="surprise_exam_list.php">Surprise Exam List</a>
                            <!-- <a class="collapse-item" href="exam_subject_question.php">Question</a> -->
                        </div>
                    </div>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="collapse" data-target="#quitz_collapse" aria-expanded="false" aria-controls="exam_collapse">
                        <i class="fas fa-edit"></i>
                        <span>Quitz</span>
                    </a>
                    <div id="quitz_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="quitz_list.php">Quiz List</a>
                            <a class="collapse-item" href="add_exam_group.php">Quiz Group</a>
                            <!-- <a class="collapse-item" href="surprise_test.php">Surprise Test</a>
                            <a class="collapse-item" href="exam_batch.php">Exam Batch</a> -->
                    ...
                    <div id="question_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="surprise_test_question.php">Surprise Test Question</a>
                             <a class="collapse-item" href="quitz_question.php">Quitz Question</a>
                            <!-- <a class="collapse-item" href="exam_subject.php">Exam Subject</a> -->
                            <!-- <a class="collapse-item" href="exam_subject_question.php">Question</a> -->
                        </div>
                    </div>
              ...
              if($_SESSION['user_type'] == 'Examiner'){
                 ...
                 <!--  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    ...
                    <div id="exam_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="examiner_long_exam_list.php">Long Term Exam</a>
                            <a class="collapse-item" href="examiner_mid_exam_list.php">Mid Term Exam</a>
                            <a class="collapse-item" href="examiner_surprise_exam_list.php">Surprise Exam List</a>
                            <a class="collapse-item" href="examiner_quiz_exam_list.php">Quiz Exam List</a>
                            <!-- <a class="collapse-item" href="exam_subject.php">Exam Subject</a> -->
                            <!-- <a class="collapse-item" href="exam_subject_question.php">Question</a> -->
                        </div>
                    </div>
             ...
             if($_SESSION['user_type'] == 'ProgSec'){
                ?>
                 <li class="nav-item">
                       <a class="nav-link" href="final_result.php">
                           <i class="fas fa-users-cog"></i>
                           <span>Final Result</span></a>
                 </li>
                 <li class="nav-item">
                       <a class="nav-link" href="traniee_certificate.php">
                           <i class="fas fa-users-cog"></i>
                           <span>Traniee Certificate</span></a>
                 </li>
                <?php
             }

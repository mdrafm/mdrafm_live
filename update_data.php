...
if($_POST['id'] != ''){
    $query = "UPDATE tbl_dept_trainee_registration SET name='$name', hrms_id='$hrms_id', designation='$designation', office_name='$office_name', email='$email',phone = '$phone',address1 = '$address1',address2 = '$address2',pin='$pin',district_id = '$district_id',addrss_flag = '$addrss_flag',per_address1 = '$per_address1',per_address2 = '$per_address2',pre_pin = '$pre_pin',per_district_id = '$perDistrict',sex='$sex' WHERE id=$id";

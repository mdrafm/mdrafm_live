                            ...
                            <form id="frm_add"  enctype="multipart/form-data">
                                ...
                                <div class="row" style="margin-left:2%;margin-right:2%;padding: 1%;">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="file" class="form-control me-2" name="cover_photo" id="image-cropper1"  value="" required>
                                        <small></small>
                                    </div>
                                    <?php
                                    $rules = array(
                                    ...
                                    <div class="col-4" style="padding: 26px;">
                                        <button type="button" class="btn btn-primary" style="padding: 10px 10px;" onclick='verify_reference_num(<?php echo json_encode($rules)  ?>,displayMessage);'>verify & Save</button>
                                    </div>
                                </div>
                            </form>
...
<script type="text/javascript">
    ...
    function verify_reference_num(rules, callback) {
        let msg_flg = '';
        console.log(rules);

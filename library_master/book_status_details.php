...
<body>
    ...
    <?php
     ...
     $db->select('tbl_book_reference_no',"DISTINCT(location)",null,null,null,null);
		...
		<div class="col-lg-6" style="">
			<div class="alert-success shadow my-3" role="alert" style="border-radius: 0px;float:right !important" id="alert_msg">
                    ...
                    <div class="card table-card">
                        ...
                        <form class="row g-6">
                        <div class="col-5">
                        <label for="" class="">Accession No.</label>
                        ...
                        <button type="button" class="btn btn-primary mb-3" onclick="get_book_details()">Show</button>
                        </div>
                        </form> 

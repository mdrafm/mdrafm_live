                 ...
                 <table class="table table-striped" id="users_tbl" style="font-size: 13px" >
                   ...
                   <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($program->en_start_date)->format('d-m-y') }}</td>
                        <td>{{ \Carbon\Carbon::parse($program->en_end_date)->format('d-m-y') }}</td>
                        <td>{{ \Carbon\Carbon::parse($program->pd_date)->format('d-m-y h:i A') }}</td>
                        <td>{{ \Carbon\Carbon::parse($program->exam_date)->format('d-m-y h:i A') }}</td>
                        <td>
                            @if($program->status == 1)
                                Active
